---
id: kibDevDocsFeedbackComponents
slug: /kibana-dev-docs/feedback/components
title: Feedback Components
description: The One Feedback UI, distributed as the standalone @kbn/ui-feedback package.
tags: ['kibana', 'feedback', 'shared-ux', 'components']
date: 2026-06-05
---

# @kbn/ui-feedback

The UI for [One Feedback](/kibana-dev-docs/feedback/plugin) — a universal way for users to rate their experience and submit feedback from anywhere in Kibana. The package is self-contained so it can be distributed to external consumers (e.g. Cloud UI) alongside Kibana itself.
...
Questions are defined per application in the `@kbn/feedback-registry` package. See the [One Feedback plugin docs](/kibana-dev-docs/feedback/plugin) for how to register them.
