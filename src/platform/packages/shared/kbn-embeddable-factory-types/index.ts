...
/**
 * DI token for registering embeddable factories via `Global` multi-binding.
 *
 * @example
 * ```ts
 ...
 * ```
 */
export const EmbeddableFactoryRegistration = Symbol.for(
  'embeddable.FactoryRegistration'
) as ServiceIdentifier<EmbeddableFactoryRegistrationEntry>;
