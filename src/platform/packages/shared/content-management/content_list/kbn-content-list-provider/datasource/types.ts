...
export interface FindItemsParams {
  ...
  searchQuery: string;
  /** Active filters including tags, users, favorites, and custom filters. */
...
/**
 * Processing strategy for content list data.
 *
 * - `'server'`: Server-side filtering, sorting, and pagination. Efficient for large datasets.
 * - `'client'`: Client-side filtering, sorting, and pagination. Fetches all items once.
 */
export type ContentListStrategy = 'client' | 'server';
