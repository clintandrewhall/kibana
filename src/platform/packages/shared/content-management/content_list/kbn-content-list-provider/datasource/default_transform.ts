...
export const defaultTransform = <T extends UserContentCommonSchema = UserContentCommonSchema>(
  ...
  return {
    ...
    isManaged,
    // Managed items cannot be favorited. Non-managed items default to undefined,
    // which means "use provider default" (show favorites if provider supports it).
    canFavorite: isManaged ? false : undefined,
    ...rest,
  };
};
