...
/**
 * Hook that provides the content editor action handler.
 *
 ...
 *
 * @returns A handler function to open the content editor for an item, or `undefined` if
 ...
 *   const openContentEditor = useContentEditorAction();
 *
 *   return (
 ...
 * ```
 */
export const useContentEditorAction = (): ((item: ContentListItem) => void) | undefined => {
