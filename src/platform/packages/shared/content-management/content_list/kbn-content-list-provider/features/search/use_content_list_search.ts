 ...
 * Tags, favorites, and other field-based filters can be included in the query text
 * using EuiSearchBar's query syntax (e.g., "tag:important is:favorite search text").
 *
