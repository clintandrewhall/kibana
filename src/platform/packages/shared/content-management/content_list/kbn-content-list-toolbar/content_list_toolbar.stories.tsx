...
export const Playground: StoryObj<PlaygroundArgs> = {
  render: (args) => {
    ...
    // Determine filtering config based on enabled filters
    ...
    return (
      <ContentListProvider
        ...
        search={args.enableSearch ? { placeholder: args.searchPlaceholder } : undefined}
        sorting={
          args.enableSorting
            ? {
                options: [
        ...
        favorites={args.enableFavorites ? { enabled: true } : undefined}
        selection={
