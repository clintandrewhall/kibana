...
/**
 * Contract for the Alpha service, published globally via `@kbn/core-di` {@link Global}.
 */
 ...
 */
export const AlphaServiceToken = Symbol.for(
  'diGlobalAlpha.AlphaService'
) as ServiceIdentifier<IAlphaService>;
