...
The button and form are provided by the [`@kbn/ui-feedback`](/kibana-dev-docs/feedback/components) package, which is also distributed standalone to external consumers. This is the trigger button the plugin registers in the global header:
