...
export function WelcomeMessageConnectors({ connectors }: { connectors: UseGenAIConnectorsResult }) {
  if (connectors.error) {
  ...
  return !connectors.loading && connectors.connectors?.length === 0 ? <Welcome.Setup /> : null;
}
